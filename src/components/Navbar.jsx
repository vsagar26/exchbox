...
const Navbar = () => {
  return (
    <div>
        <nav className='flex flex-row justify-center items-center gap-4 ss:gap-[200px] sm:gap-[320px] md:gap-[400px] lg:gap-[500px] py-3 w-[550px] sm:w-full'>
            <div className=' '><a href="/"><img src={logo} alt="logo" className='logo ml-[40px] sm:ml-[100px] lg:px-2 h-[40px] md:h-[55px] lg:h-[70px]'/></a></div>
