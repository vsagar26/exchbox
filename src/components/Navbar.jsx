...
const Navbar = () => {
  return (
    <div>
        <nav className='flex flex-row justify-center items-center gap-4 xs:gap-[50px] ss:gap-[200px] sm:gap-[320px] md:gap-[400px] lg:gap-[550px] py-3 w-[550px] sm:w-full'>
            <div className=' '><a href="/"><img src={logo} alt="logo" className='logo ml-[-50px] lg:px-2 h-[40px] md:h-[55px] lg:h-[70px]'/></a></div>
