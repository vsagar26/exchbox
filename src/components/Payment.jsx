...
const Payment = () => {
  return (
    <section className={`flex flex-col mt-8 pb-20 w-[550px] sm:w-full `} id='payment'>
      <div>
        <h2 className="max-lg:text-[36px] text-[40px] text-center pt-5 w-full">
          AVAILABLE PAYMENT METHODS
        </h2>
      </div>
      <div className={`bg-white mt-2`}>
        <div className={` w-full mt-10 flex flex-col md:flex-row sm:w-[150px] items-center max-[550px]:w-[180px] ml-48 sm:ml-0 `}>
